...
function run_kernel_make_internal() {
	...
	common_make_params_quoted=(
		...
		"LOCALVERSION=" # Change the internal kernel version to include the family. Changing this causes recompiles # @TODO change hack at .config; that might handles mtime better
